...
def load_df(csv_path='/Users/yanguangyu/Desktop/kaggle/store/all/train.csv', nrows=None):
...
print(os.listdir("/Users/yanguangyu/Desktop/kaggle/store"))


# In[ ]:


get_ipython().run_cell_magic('time', '', 'df_small = load_df()')


# In[ ]:


get_ipython().run_cell_magic('time', '', 'df_train = load_df()\ndf_test = load_df("/Users/yanguangyu/Desktop/kaggle/store/all/test.csv")')
